...
public class BHeapMain {
	...
	public static void main(String[] args) {
		...
		a[1] = new Entry(90, "watemelon"); a[2]=new Entry(80,"pear");
		...
		System.out.println("min »èÁ¦ ÈÄ"); System.out.println(h.delteMin().getValue());
		h.print();
		h.insert(5, "apple"); System.out.println("5 »ğÀÔÈÄ"); h.print();
	}
